...
function Harness({ initial = 'b', size }: { initial?: string; size?: 'sm' | 'md' }) {
  const [v, setV] = useState(initial);
  return (
    <>
      <SegmentedControl aria-label="Görünüm" value={v} onChange={setV} size={size} options={[
